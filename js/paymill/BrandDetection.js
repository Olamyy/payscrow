PayScrowBrandDetection = function() {};

PayScrowBrandDetection.prototype.option =
{
    'minlength': 6
};

PayScrowBrandDetection.prototype.creditcard =
{
    'carte-bleue' : {
...
PayScrowBrandDetection.prototype.detect = function(cardnumber)
{
    var brand = 'unknown';
...
PayScrowBrandDetection.prototype.validate = function(cardnumber)
{
    return this.creditcard[this.detect(cardnumber)].cardlength.indexOf(cardnumber.length)  !== -1;
};

PayScrowBrandDetection.prototype.luhn = function(cardnumber)
{
    //todo
};