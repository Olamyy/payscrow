PayScrowIban = function() {
};
PayScrowIban.prototype.countries = {
    'AL': 28,
    'AD': 24,
    'AZ': 28,
    'BH': 22,
...
PayScrowIban.prototype.alphabet = {
    'A': '10',
    'B': '11',
    'C': '12',
    'D': '13',
...
PayScrowIban.prototype.iban = '';

PayScrowIban.prototype.validate = function(iban) {
...
PayScrowIban.prototype.checkString = function() {
...
PayScrowIban.prototype.changeCharacterPosition = function() {
...
PayScrowIban.prototype.calculate = function(iban) {
    start = 0;
    length = 9;
    loop = true;
    remainder = '';
